...
│   ├── img
```
In folder "data/ReCTS/", "TDA_ReCTS_train_list.txt" and "TDA_ReCTS_val_list.txt" download from [TDA-ReCTS](https://github.com/whai362/TDA-ReCTS). Other json files can be 
